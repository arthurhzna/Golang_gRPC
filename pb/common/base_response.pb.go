...
type BaseResponse struct {
	...
	ValidateErrors []*ValidateError       `protobuf:"bytes,4,rep,name=validate_errors,json=validateErrors,proto3" json:"validate_errors,omitempty"` // more than one validation error (repeated field)
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *BaseResponse) GetValidateErrors() []*ValidateError {
	if x != nil {
...
const file_common_base_response_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/base_response.proto\x12\x06common\"?\n" +
	"\rValidateError\x12\x14\n" +
	...
	"\x0fvalidate_errors\x18\x04 \x03(\v2\x15.common.ValidateErrorR\x0evalidateErrorsB-Z+github.com/arthurhzna/Golang_gRPC/pb/commonb\x06proto3"
...
var file_common_base_response_proto_goTypes = []any{
	(*ValidateError)(nil), // 0: common.ValidateError
	(*BaseResponse)(nil),  // 1: common.BaseResponse
}
var file_common_base_response_proto_depIdxs = []int32{
	0, // 0: common.BaseResponse.validate_errors:type_name -> common.ValidateError
